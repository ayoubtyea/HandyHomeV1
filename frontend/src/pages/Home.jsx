...
<h1 className="text-4xl sm:text-5xl md:text-6xl font-light text-gray-900 mt-1 flex items-center">
  <span>with</span>
                    ...
                    <p className="text-2xl sm:text-3xl font-bold text-gray-900">
                      {stat.value.includes('+') || stat.value.includes('%') ? (
                        <>
                          ...
                          <span className="text-[#076870]">{stat.value.match(/[+%]/g)}</span>
                        </>
                      ) : stat.value}
                    </p>
            ...
            >
                ...
                <div className="relative">
                  ...
                  <div className="bg-[#076870] md:-ml-10 p-4 sm:p-6 rounded-lg text-white mt-4 w-full md:w-auto">
                    <div className="p-2 flex">
                      <span className="text-2xl sm:text-3xl md:text-4xl font-medium">12+ Years</span>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-1 items-center">
                      <div className="w-full sm:w-1/2">
                        <p className="text-sm sm:text-base">We are growing with happy clients</p>
                      </div>
                      <div className="flex gap-1">
                        {[
                          "https://i.postimg.cc/s2VFXCY6/66408e2a50f24b34f7114882-avatar-3.jpg",
                          "https://cdn.prod.website-files.com/663b34c56f05c8c9e12aafdc/66408e2a0bd1803c9a5f812b_avatar-2.jpg",
                          "https://cdn.prod.website-files.com/663b34c56f05c8c9e12aafdc/66408ed4725564404bc621c8_avatar-1.jpg"
                        ].map((avatar, i) => (
                          <img
                            key={i}
                            src={avatar}
              ...
              <div className="static">
                ...
                <div className="md:absolute top-0 left-2/3 transform md:-translate-x-1/5 bg-black text-white text-center flex items-center rounded-full p-4 z-10 mb-2 md:mb-0">
                  ...
                  <p className="text-xs sm:text-sm ml-2">Free Home Services in the next 7 days!</p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            >
              <div className="text-center md:text-left">
                <div className="inline-block border-x-4 border-[#076870] text-[#076870] rounded-md px-6 py-2">
                  <h2>About Us</h2>
                </div>
          ...
          <div className="gap-10 items-center py-8 px-4 mx-auto max-w-6xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="about-group-block">
                <div className="bg-gradient-to-r from-indigo-400 to-sky-200 p-6 rounded-lg">
                  <h3 className="text-xl sm:text-2xl font-bold text-gray-900">24/7 Support</h3>
                  <div className="mt-4">
                    <p className="text-gray-600">We provide 24/7 service to our customers</p>
                    <Link
                      to="/contact"
                      className="mt-4 inline-flex items-center text-blue-100 hover:text-[#0f7780] transition-colors"
                    >
                      Contact Us
                      <svg
                ...
                {[
                  {
                    ...
                    title: "Our Story",
                    description: "HandyHome was born out of a passion for excellence and a desire to simplify the way people experience home services."
                  },
                  {
                    icon: (
                      <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  },
                  {
                    ...
                    description: "At HandyHome, we stand out for our unwavering commitment to excellence in every aspect of what we do."
                  }
                ].map((item, index) => (
                  <div key={index} className="p-6 rounded-lg flex">
